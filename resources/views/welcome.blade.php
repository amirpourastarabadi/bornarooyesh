    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#footer"> تماس با ما
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#about-us"> درباره ما
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#products"> محصولات
                        </a>
                    </li>
                    <li class="nav-item">
...
<div class="container">
    ...
    <div id="carouselExampleCaptions" class="carousel slide mt-4" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/slide1.jpg" class="d-block w-100" alt="..." width="810" height="400">
            ...
            <div class="carousel-item">
                <img src="./images/slide2.jpg" class="d-block w-100" alt="..." width="810" height="400">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="./images/slide3.jpg" class="d-block w-100" alt="..." width="810" height="400">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Second slide label</h5>
                    <p>Some representative placeholder content for the second slide.</p>
                </div>
    ...
    <div class="row px-2 my-5">
        <div class="col-12 bg-dark text-center p-5" id="about-us">
            <p class="">
            <h5>آب آرا</h5>
    ...
    <div class="row mt-5" id="products">
        <div class="col-12 text-center">
            <h2 class="mt-5">محصولات برنارویش</h2>
        </div>
    </div>

    <div class="row d-flex justify-content-center my-5">
        <div class="col-md-3 col-sm-12 d-flex justify-content-between">
            <div class="card border border-secondary text-center p-2" style="width: 18rem;">
                <img src="./images/products.webp" class="card-img-top" alt="...">
                <div class="card-body mt-3">
                    <h5 class="card-title">محصول ۱</h5>
                    <p class="card-text">توضیحات محصول</p>
                    <a href="#" class="btn btn-primary">بیشتر</a>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-12  mx-5 d-flex justify-content-between">
            <div class="card border border-secondary text-center p-2" style="width: 18rem;">
                <img src="./images/products.webp" class="card-img-top" alt="...">
                <div class="card-body mt-3">
...
<div class="container-fluid mt-4" style="">
    ...
    <div class="footer" id="footer">
        <div class="row  pt-5" style="background-color: #D0F0C0;min-height: 350px">
            <div class="col-md-4 col-sm-12 text-center px-2 py-3">
            ...
            <div class="col-md-4 col-sm-12 text-center px-4 pt-5 mt-5">
                <a href="" style="text-decoration: unset;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                         class="bi bi-telegram mx-4" viewBox="0 0 16 16">
                        <path
                            d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.287 5.906c-.778.324-2.334.994-4.666 2.01-.378.15-.577.298-.595.442-.03.243.275.339.69.47l.175.055c.408.133.958.288 1.243.294.26.006.549-.1.868-.32 2.179-1.471 3.304-2.214 3.374-2.23.05-.012.12-.026.166.016.047.041.042.12.037.141-.03.129-1.227 1.241-1.846 1.817-.193.18-.33.307-.358.336a8.154 8.154 0 0 1-.188.186c-.38.366-.664.64.015 1.088.327.216.589.393.85.571.284.194.568.387.936.629.093.06.183.125.27.187.331.236.63.448.997.414.214-.02.435-.22.547-.82.265-1.417.786-4.486.906-5.751a1.426 1.426 0 0 0-.013-.315.337.337 0 0 0-.114-.217.526.526 0 0 0-.31-.093c-.3.005-.763.166-2.984 1.09z"/>
                    </svg>
                </a>
                <a href="" style="text-decoration: unset;color: red">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                         class="bi bi-instagram mx-3" viewBox="0 0 16 16">
                        <path
                ...
                <a href="" style="text-decoration: unset; color: blue;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                         class="bi bi-linkedin mx-4" viewBox="0 0 16 16">
                        <path
                            d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
                    </svg>
                </a>
            </div>
            <div class="col-md-4 col-sm-12 text-center px-4 py-3 ml-5">
                <p>
